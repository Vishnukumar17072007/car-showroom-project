  ...
  return (
    <>
      <div className="car-card" style={{ marginLeft: "13px" }}>
        <div
          className="car_image"
          onClick={() => navigate(`/vehicles/${props._id}`)}
        >
          <img
            src={props.image}
        ...
        <div className="car_card_body">
          <div className="car_title">
            ...
            <p className="p-1" style={{ fontWeight: "lighter", margin: "0%" }}>
              {props.brand}.{props.bodyType}
            </p>
          </div>
            ...
            <div className="editModal">
              <div className="editModalContent">
                ...
                <input
                  ...
                  defaultValue={editData.frontImage}
                  onChange={(e) =>
                    setEditData({ ...editData, frontImage: e.target.value })
                  }
                />
                ...
                <input
                  ...
                  defaultValue={editData.rearImage}
                  onChange={(e) =>
                    setEditData({ ...editData, rearImage: e.target.value })
                  }
                />
                ...
                <input
                  ...
                  defaultValue={editData.rightSideImage}
                  onChange={(e) =>
                    setEditData({ ...editData, rightSideImage: e.target.value })
                  }
                />
                ...
                <input
                  ...
                  defaultValue={editData.leftSideImage}
                  onChange={(e) =>
                    setEditData({ ...editData, leftSideImage: e.target.value })
                  }
                />
                ...
                <input
                  ...
                  defaultValue={editData.bodyType}
                  onChange={(e) =>
                ...
                <input
                  ...
                  defaultValue={editData.transmission}
                  onChange={(e) =>
                ...
                <input
                  ...
                  defaultValue={editData.engineType}
                  onChange={(e) =>
                ...
                <input
                  ...
                  defaultValue={editData.available}
                  onChange={(e) =>
                    setEditData({
                      ...editData,
